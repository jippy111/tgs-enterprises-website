    ...
    <main className="min-h-screen bg-[#fff8fb] text-stone-950">
      <header className="border-b border-pink-100 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          ...
          <img src="/assets/little-jessie-logo.jfif" alt="Little Jessie Studyo" className="h-12 w-auto object-contain" />
        </div>
      </header>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-2 md:items-center md:py-20">
        ...
        <div className="border border-pink-100 bg-white p-8 shadow-sm">
          <img src="/assets/little-jessie-logo.jfif" alt="Little Jessie Studyo logo" className="mx-auto max-h-72 w-full object-contain" />
        </div>
      </section>
