-- Launch MVP policies for browser-based Supabase sync.
-- Run this after schema.sql if Row Level Security is enabled.
-- Tighten these before high-volume public launch with Supabase Auth roles.
